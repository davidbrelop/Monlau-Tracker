...
public class FillAttendanceTask extends AsyncTask<String, Void, String> {

    private Context context;
    private Exception exception;

    public FillAttendanceTask(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        String url = "http://172.17.127.254:8200/webservice/rest/fill_attendance_by_username.php";
