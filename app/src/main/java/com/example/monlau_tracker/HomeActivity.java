...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            GetCurrentStatusTask getCurrentStatusTask = (GetCurrentStatusTask) new GetCurrentStatusTask(HomeActivity.this).execute(username);
    ...
    private void cerrarSesion() {
        ...
        editor.remove("avisado");
        editor.remove("geolocation");
