...
public class GetCurrentStatusTask extends AsyncTask<String, Void, String> {

    private Context context;
    private Exception exception;

    public GetCurrentStatusTask(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        String url = "http://172.17.127.254:8200/webservice/rest/get_current_status_by_username.php";
    ...
    protected void onPostExecute(String resultado) {
        ...
        if (exception != null) {
            ...
            editor.putString("status", resultado);
            editor.apply();

            if(!(context instanceof LoginActivity) && !(context instanceof CardActivity)){
